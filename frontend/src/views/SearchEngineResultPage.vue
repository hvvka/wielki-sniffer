<template>
    <v-container fluid v-if="getSearchResults && getSearchData">
        <v-row justify="center">
            <v-col cols="2">
                <div style="position: fixed;">
                    ...
                    <div class="mt-7">
                        <h4>Contributors</h4>
                        <div v-for="contributor in getSearchResults.contributors" :key="'contributor_'+contributor.name">
                        ...
                        <div v-for="category in getSearchResults.categories" :key="'category_'+category.name">
                            <span class="link" @click="categoryClickHandler">{{category.name}} ({{category.count}})</span>
                        </div>
                    </div>
                </div>
            </v-col>
            <v-col cols="7">
                ...
                <v-row>
                    <v-col v-for="(book, index) in getSearchResults.books" :key="index" xs="12" sm="12" md="6" lg="6" xl="6">
